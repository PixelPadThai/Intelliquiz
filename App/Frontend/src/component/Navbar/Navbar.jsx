...
//       <div className="flex items-center list-none mr-96 gap-7 max-w-16">
//         <li className="hover:text-sky-400  font-semibold text-lg">
//           <Link to="/">Home</Link>
//         </li>
//         <li className="hover:text-sky-400 font-semibold text-lg">
...
//         </li>
//         <li className="hover:text-sky-400 font-semibold text-lg">
//           <Link to="/contatc">ContactUs</Link>
//         </li>
//         {firebase.isLoggedIn ? (
//           <p className="w-12 h-12 ">
//             <CgProfile className="w-12  -mt-2 h-16 " />
//           </p>
//         ) : (
//           <li
//             className="py-2 px-4 text-white bg-transparent border-2 border-white rounded-md hover:bg-white hover:text-black hover:font-semibold transition-all duration-300"
